...
$.widget( "evol.colorpicker", {
	...
	options: {
		...
		//add by hexuerong	:	there are callbacks for hide or show palette
		hidePaletteCallback:null,
		showPaletteCallback:null,
		fadeOut:true,//fadeOut or not
	},
	...
	showPalette: function() {
		if(this._enabled){
			...
			if(this._palette===null){
				...
				if(this.options.showPaletteCallback){
					this.options.showPaletteCallback();
				}
			}
		}
		return this;
	...
	hidePalette: function() {
		if(this._isPopup && this._palette){
			...
			if(this.options.hidePaletteCallback){
				this.options.hidePaletteCallback();
			}
		}
		return this;
	},
